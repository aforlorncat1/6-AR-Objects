...
We've previously looked at how to create new records in the database and read records from the database.  In this exercise, we've now addressed updating and deleting records in our database.  Create, read, update, and delete (CRUD).  These are the four basic functions for persisting data in a database, and they will form the backbone of our applications as we move forward through Recode.  While these might still be somewhat new to us, we'll continue to build familiarity with them.
